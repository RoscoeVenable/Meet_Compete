    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Eventee", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Eventee_AspNetUsers_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventPlaner", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventPlaner_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Event_EventPlaner_EventPlannerId",
                        column: x => x.EventPlannerId,
                        principalTable: "EventPlaner",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Event_EventPlannerId",
                table: "Event",
                column: "EventPlannerId");

            migrationBuilder.CreateIndex(
                name: "IX_Eventee_IdentityUserId",
                table: "Eventee",
